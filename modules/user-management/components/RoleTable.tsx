      ...
      <TableBody>
        {roles.map(role => (
          <TableRow key={role._id}>
            ...
            <TableCell>
              <Button variant="ghost" size="icon" onClick={() => handleEdit(role._id, {name: role.name, description: role.description, permissions: role.permissions.map(permission => permission.code) as Permission[]})}>
                <EditIcon />
              </Button>
            </TableCell>
            <TableCell>
